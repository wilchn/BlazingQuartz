        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    run_instance_id = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    ...
                    return_code = table.Column<string>(type: "character varying(28)", maxLength: 28, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    error_help_link = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "ix_bqz_execution_logs_trigger_name_trigger_group_job_name_job_",
                table: "bqz_execution_logs",
